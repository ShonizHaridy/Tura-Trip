...
//           {/* Icon */}
//           <div className="flex items-center justify-center w-12 h-full md:w-14">
//             <RiTelegram2Fill className="w-6 h-6 md:w-7 md:h-7" />
//           </div>
...
const EdgeSocialMedia = () => {
  ...
  return (
    <div className="fixed right-4 top-[80%] lg:top-[60%] transform -translate-y-1/2 z-50 flex flex-col space-y-3">
      
      {/* Telegram Button First - Keep the circular blue background */}
      <button
        onClick={handleTelegramClick}
        className="w-10 h-10 md:w-12 md:h-12 bg-[#0088cc] hover:bg-[#006fa8] hover:scale-110 text-white rounded-full transition-all duration-300 flex items-center justify-center cursor-pointer"
        title="Contact us on Telegram"
      >
        <RiTelegram2Fill className="w-6 h-5 md:w-7 md:h-7" />
      </button>

      {/* WhatsApp Button Second - Clean transparent background */}
      <button
        onClick={handleWhatsAppClick}
        className="w-10 h-10 md:w-12 md:h-12 hover:scale-110 text-[#25D366] transition-all duration-300 flex items-center justify-center cursor-pointer"
