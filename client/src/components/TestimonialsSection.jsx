// src/components/TestimonialsSection.jsx - WITH ZOOM FUNCTIONALITY
import React, { useState } from "react";
import { useTranslation } from "react-i18next";
import { ArrowLeft2, ArrowRight2, CloseSquare } from "iconsax-react";

const TestimonialsSection = ({ reviews, totalCount = 200 }) => {
  const { t } = useTranslation();
  const [currentSlide, setCurrentSlide] = useState(0);
  const [isImageZoomed, setIsImageZoomed] = useState(false); // ✅ NEW: Zoom state
          ...
          <div className="relative">
            <div className="flex flex-col justify-center items-center gap-12">
              ...
              <div className="lg:hidden w-full max-w-[343px] mx-auto">
                <div className="relative">
                  {/* ✅ UPDATED: Added click handler and cursor pointer */}
                  <img
                    src={currentTestimonial.screenshot_image_url || "https://via.placeholder.com/129x251"}
                    alt="Review screenshot"
                    className="w-[129px] h-[251px] object-cover rounded-xl mx-auto mb-2 cursor-pointer hover:opacity-90 transition-opacity"
              ...
              <div className="hidden lg:flex justify-center items-center max-w-6xl mx-auto">
                <div className="flex items-center gap-8 bg-white rounded-2xl p-6 shadow-[0px_14px_42px_0px_rgba(20,20,43,0.14)] w-full">
                  ...
                  <img
                    ...
                    alt="Review screenshot"
                    className="w-[200px] h-[400px] object-cover rounded-xl flex-shrink-0 cursor-pointer hover:opacity-90 transition-opacity"
                    onClick={handleImageClick}
                    onError={(e) => {
      ...
      {isImageZoomed && (
        ...
        >
          ...
          <div className="relative max-w-[90vw] max-h-[90vh] flex items-center justify-center">
            <img
              src={currentTestimonial.screenshot_image_url || "https://via.placeholder.com/400x800"}
              alt="Review screenshot - Zoomed"
              ...
              onError={(e) => {
                e.target.src = "https://via.placeholder.com/400x800";
              }}
            />
          </div>
          ...
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-white/80 text-sm text-center">
            <p>Click anywhere to close • Press ESC to close</p>
          </div>
        </div>
      )}
